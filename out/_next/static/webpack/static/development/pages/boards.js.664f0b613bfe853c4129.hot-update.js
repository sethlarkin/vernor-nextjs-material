...
function BoardCard(props) {
  ...
  var model = props.name.split(' ')[0].toLowerCase() === 'the' ? props.name.split(' ')[1].toLowerCase() : props.props.name.split(' ')[0].toLowerCase();
  return __jsx("div", {
    style: {
      padding: "10px"
    },
...
//# sourceMappingURL=boards.js.664f0b613bfe853c4129.hot-update.js.map