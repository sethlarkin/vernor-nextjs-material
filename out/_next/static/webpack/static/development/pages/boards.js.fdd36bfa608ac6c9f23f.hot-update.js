...
function BoardCard(props) {
  ...
  var model = props.name.includes('the') ? props.name.split(' ')[1].toLowerCase() : props.name.split(' ')[0].toLowerCase();
  return __jsx("div", {
    style: {
      padding: "10px"
    },
...
//# sourceMappingURL=boards.js.fdd36bfa608ac6c9f23f.hot-update.js.map