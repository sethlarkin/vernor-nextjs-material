...
function BoardCard(props) {
  ...
  var model = props.name.split(' ')[0].toLowerCase() === 'the' ? props.props.name.split(' ')[1].toLowerCase() : props.props.name.split(' ')[0].toLowerCase();
  return __jsx("div", {
    style: {
      padding: "10px"
    },
...
//# sourceMappingURL=boards.js.4b997c34affe3dd7a9a8.hot-update.js.map