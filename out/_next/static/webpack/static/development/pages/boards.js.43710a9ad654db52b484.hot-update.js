...
function BoardCard(props) {
  ...
  var model = props.props.name.split(' ')[0].toLowerCase() === 'the' ? props.props.name.split(' ')[1].toLowerCase() : props.props.name.split(' ')[0].toLowerCase();
  return __jsx("div", {
    style: {
      padding: "10px"
    },
    ...
    href: "/board-page/" + props.name.split(' ')[0].toLowerCase(),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
...
//# sourceMappingURL=boards.js.43710a9ad654db52b484.hot-update.js.map