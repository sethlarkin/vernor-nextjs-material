...
function BoardCard(props) {
  ...
  var model = props.name.replace('The ', '').split(' ')[0].toLowerCase();
  return __jsx("div", {
    style: {
      padding: "10px"
    },
  ...
  }, "strong", props.name), __jsx(next_link__WEBPACK_IMPORTED_MODULE_7___default.a, {
    href: "/board-page/" + model,
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 60,
...
//# sourceMappingURL=boards.js.00d809709c71314a51d6.hot-update.js.map