...
function createData(name, polyurethane, eps, fat, carbs, protein) {
  return {
    name: name,
    calories: calories,
    fat: fat,
...
var rows = [createData('Glass', 'Direct-Size Hexcel', 'Direct-Size Hexcel'), createData('Resin', "Y2K Solar Polyester", "Epoxy (35% more flexible)", 37, 4.3), createData('Foam', "Polyurethane", "2 lb. EPS"), createData('Stringer', "Bass wood", "Bass, Poplar, PVC"), createData('Fins', "Futures Fins ", "Futures Fins")];
function AcccessibleTable() {
  ...
  return __jsx(_material_ui_core_TableContainer__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    }, row.polyurethane), __jsx(_material_ui_core_TableCell__WEBPACK_IMPORTED_MODULE_4__["default"], {
      align: "right",
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=tech.js.6b3638f35a907b2e97d5.hot-update.js.map